...
try:
    from .yolo_wrapper import Detection, InferenceResult, YOLOWrapper
except ImportError:
    from yolo_wrapper import Detection, InferenceResult, YOLOWrapper
...
try:
    ...
    from image_conversion import compressed_image_msg_to_bgr8, image_msg_to_bgr8


SOURCE_NAME = "person_follower"
BUILD_MARKER = "person_follow stereo-local-yolo direct-image v0.1.2"
